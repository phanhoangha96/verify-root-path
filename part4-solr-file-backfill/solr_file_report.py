...
class BackfillReport:
    ...
    skipped_missing_attachment: int = 0
    ...
    def add_skip(self, row: IssueRow) -> None:
        field = {
            "MISSING_DEPT_ID": "skipped_missing_dept",
            "MISSING_ATTACHMENT": "skipped_missing_attachment",
            "MISSING_FILE_SERVICE_ID": "skipped_missing_file",
...
def write_reports(report: BackfillReport, output_dir: Path, stamp: str, output_file: str = "") -> Dict[str, Path]:
    ...
    if output_file:
        ...
        base = f"solr_doc_file_backfill_{stamp}"
    ...
    payload = {
        ...
        "skipped_missing_attachment": report.skipped_missing_attachment,
    ...
    for bucket in report.by_key.values():
        summary.append(
            [
                ...
                bucket.get("skipped_missing_attachment", 0),
